...
description: a decision about ui elements should be made after consulting this file
---

this project uses shadcn ui for all ui elements. If shadcn ui is not initialized in our project use the following command: 
npx shadcn@latest init

if a particular component is not installed, use the following command (for example to install the button component):
